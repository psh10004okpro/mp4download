...
**⭐ 가장 쉬운 방법 (인코딩 문제 없음!)**
```
1️⃣ START.bat 더블클릭  ← 이것 사용하세요!
2️⃣ Python 없으면 자동 설치 안내
3️⃣ GUI 창 열림
4️⃣ URL 복사 → 자동 붙여넣기
5️⃣ Enter 두 번 → 다운로드 완료! 🎉
```
...
**📖 English Guide:** [QUICK_START.txt](QUICK_START.txt) ⚡
**📖 한글 가이드:** [사용방법_간단가이드.md](사용방법_간단가이드.md)
...
### 2. Windows 데스크톱 프로그램 ⭐⭐ (가장 추천!)
- 🎯 **원클릭 설치 및 실행** - `설치_및_실행.bat` 더블클릭으로 끝!
- 🎨 사용하기 쉬운 GUI 인터페이스
- 🔍 자동 URL 감지 (클립보드 모니터링)
- 📊 실시간 다운로드 진행률 표시
- **👉 [초간단 사용법 보기](사용방법_간단가이드.md)** ⚡
- **👉 [상세 가이드 보기](README_WINDOWS.md)**
